...
const qoutes:string='"When you succeed be Humble."';
console.log("Imam Ali once said,",qoutes);
      //Exercise 5
//Famous Quote: Find a quote from a famous person you admire. Print the quote and the name of its author. Your output should look something like the following, including the quotation marks:
//Imam Ali once said, "When you succeed be Humble."
const famousPerson:string= '"Imam Ali"';
const qoute:string='"When you succeed be Humble"';
...
const personsName:string="\t  Saman  \n";
...
const favNumber:number=786;//in this vaiable we store favorite num
const messages:string= 'My favourite nunmber is ${favNumber} .';//in this variable we define variable that store favourite number
console.log(messages);

      //Exercise  10
//Names: Store the names of a few of your friends in a array called names. Print each person’s name by accessing each element in the list, one at a time.*/
let friendsName:string[]=["ayesha","samra","rimsha","konain"]
...
let friendsName1:string[]=["ayesha","samra","rimsha","konain"]
...
let ownArray:string[]=["motorcycle","car","bicycle","heavy bike","bus","train"];
let properties:string[]=["is old but mazadar.","is gift from relatives.","is four seater.","is to much expensive.","is use for public transport."]
...
let guest:string[]=["fatima","ayesha","samra","meharmah"];
console.log(guest);
...
var places:string[]=["Makkah","Madinah","Iraq,karbla","Dubai","Italy"];
console.log(places);
